  ...
  */
  ...
  function create_fragment(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			h1 = element("h1");
  			h1.textContent = "GreenSock ScrollSmoother on a Svelte App";
  			t1 = space();
  			button = element("button");
  			button.textContent = "Jump to C";
  			t3 = space();
  			div0 = element("div");
  			div0.textContent = "a";
  			t5 = space();
  			...
  			add_location(h1, file, 36, 3, 920);
  			attr_dev(button, "class", "button");
  			add_location(button, file, 37, 3, 987);
  			attr_dev(header, "class", "header");
  			add_location(header, file, 35, 2, 893);
  			attr_dev(div0, "class", "box box-a");
  			attr_dev(div0, "data-speed", "0.5");
  			add_location(div0, file, 39, 2, 1065);
  			attr_dev(div1, "class", "box box-b");
  			attr_dev(div1, "data-speed", "0.8");
  			add_location(div1, file, 40, 2, 1115);
  			attr_dev(div2, "class", "box box-c");
  			attr_dev(div2, "data-speed", "1.5");
  			add_location(div2, file, 41, 2, 1165);
  			attr_dev(div3, "class", "line");
  			add_location(div3, file, 42, 2, 1215);
  			attr_dev(div4, "id", "smooth-content");
  			add_location(div4, file, 34, 1, 865);
  			attr_dev(div5, "id", "smooth-wrapper");
  			add_location(div5, file, 33, 0, 821);
  			attr_dev(img, "class", "greensock-icon");
  			if (!src_url_equal(img.src, img_src_value = "https://s3-us-west-2.amazonaws.com/s.cdpn.io/16327/scroll-smoother-logo-light.svg")) attr_dev(img, "src", img_src_value);
  			attr_dev(img, "width", "220");
  			attr_dev(img, "height", "70");
  			attr_dev(img, "alt", "GreenSock");
  			add_location(img, file, 47, 2, 1311);
  			attr_dev(a, "href", "https://greensock.com/scrollsmoother");
  			add_location(a, file, 46, 1, 1261);
  			add_location(footer, file, 45, 0, 1251);
  		},
  		...
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(button, "click", /*scrollTo*/ ctx[1], false, false, false, false);
  				mounted = true;
  			}
  		},
  		p: noop,
  ...
  function instance($$self, $$props, $$invalidate) {
  	...
  	$$self.$inject_state = $$props => {
  		...
  		if ('smoother' in $$props) smoother = $$props.smoother;
  	};
  	...
  	return [main, scrollTo, div5_binding];
  }
  ...
  gsapWithCSS.registerPlugin(ScrollTrigger, x);
